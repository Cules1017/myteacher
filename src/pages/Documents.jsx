...
function Documents() {
  return (
    <>
      ...
      <main className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {documents.map((doc) => (
          <a key={doc.title} href={doc.href} target="_blank" rel="noreferrer">
            <GlassCard accent={doc.accent}>
              ...
              <div className="relative flex flex-col gap-1.5">
                ...
                <p className="text-sm leading-relaxed text-slate-300">{doc.description}</p>
              </div>
